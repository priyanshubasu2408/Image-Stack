...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand fs-4" href="#">Image Stack</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link fs-5" href="#footer">Contact Us</a>
        </li>
        <?php if (!isset($_SESSION['user_id'])): ?>
          ...
          <li class="nav-item">
            <a class="nav-link fs-5" href="signup.php">Signup</a>
          </li>
        <?php else: ?>
          <li class="nav-item">
...
<footer id="footer" class="bg-primary text-white text-center py-3 mt-5">
  <div class="container">
    <p>&copy; <?= date('Y') ?> Image Stack. All Rights Reserved.</p>
    <p>Created using the <b>pexels.com</b> API.</p>
    <div class="d-flex justify-content-center">
      <a href="#" class="text-white mx-2"><i class="material-symbols-outlined">facebook</i></a>
      <a href="#" class="text-white mx-2"><i class="material-symbols-outlined">twitter</i></a>
      <a href="#" class="text-white mx-2"><i class="material-symbols-outlined">instagram</i></a>
    </div>
  </div>
</footer>
